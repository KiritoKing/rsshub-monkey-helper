  ...
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        ...
        updateURL:
          'https://github.com/chlorinec/rsshub-monkey-helper/releases/latest/download/rsshub-monkey-helper.meta.js',
        downloadURL:
          'https://github.com/chlorinec/rsshub-monkey-helper/releases/latest/download/rsshub-monkey-helper.user.js',
      },
      server: {
        open: true,
